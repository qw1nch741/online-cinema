...
app = FastAPI(
    ...
    description=(
        ...
        "7. `POST /auth/change-password` — change account password (Bearer required)\n"
        "8. `POST /auth/forgot-password` — request password reset token\n"
        "9. `POST /auth/reset-password` — reset password using token\n\n"
        "## Using Swagger UI\n"
