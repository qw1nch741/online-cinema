...
class MovieCreate(BaseModel):
    ...
    title: str = Field(..., max_length=512, description="Movie title", examples=["Inception"])
    ...
    duration_minutes: int = Field(..., gt=0, description="Runtime in minutes", examples=[148])
    release_year: int = Field(..., ge=1888, le=2026, description="Year of release", examples=[2010])
